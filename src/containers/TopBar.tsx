...
import Logo from '@mimiar-wallet/assets/images/logo.png';
import { ReactComponent as IconMenu } from '@mimiar-wallet/assets/svg/icon-menu.svg';
import { ReactComponent as IconSetting } from '@mimiar-wallet/assets/svg/icon-set.svg';
import LogoCircle from '@mimiar-wallet/assets/svg/logo-circle.svg';
import { AccountSelect, ChainSelect } from '@mimiar-wallet/components';
import { useApi } from '@mimiar-wallet/hooks';
