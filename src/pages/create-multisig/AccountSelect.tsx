...
import { ReactComponent as IconAdd } from '@mimiar-wallet/assets/svg/icon-add.svg';
import { ReactComponent as IconDelete } from '@mimiar-wallet/assets/svg/icon-delete.svg';
