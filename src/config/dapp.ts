...
import { FAVORITE_DAPP_KEY } from '@mimiar-wallet/constants';
...
export const dapps: DappOption[] = [
  {
    ...
    name: 'Transfer',
    description: 'Swiftly complete asset transfers with other users, developed by mimiar.',
    url: '/transfer',
    supportedChains: true,
    tags: ['Assets'],
    website: 'https://mimiar.global',
    twitter: 'https://twitter.com/mimiar_global',
    github: 'https://github.com/mimiar-labs'
  },
  {
    id: 1000,
    internal: false,
    ...
    name: 'Apps',
    description: 'Using the mimiar-modified version of the Polkadot.js App, users can quickly perform all operations related to Substrate.',
    url: 'https://apps.mimiar.global/',
    supportedChains: true,
    tags: ['Wallet', 'Tool'],
  ...
  },
  {
    ...
    url: 'https://staking.mimiar.global/',
