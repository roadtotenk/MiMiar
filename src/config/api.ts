...
export const localEndpoint: Endpoint = { icon: '/chain-icons/mimiar.svg', tokenIcon: '/token-icons/mimiar.svg', name: 'Development', wsUrl: 'ws://127.0.0.1:9944/' };
export const devEndpoints: Endpoint[] = [
  {
    icon: '/chain-icons/mimiar.svg',
    tokenIcon: '/token-icons/mimiar.svg',
    name: 'mimiar',
    wsUrl: 'wss://dev-ws.mimiar.global/',
    genesisHash: '0xc47e0ed91f4362642787756a15618b5cb558a3952187c6dfb3fb8e9db5128678',
    serviceUrl: 'https://dev-api.mimiar.global/',
...
export const testnetEndpoints: Endpoint[] = [
  {
    ...
    serviceUrl: 'https://rococo-api.mimiar.global/',
...
export const polkadotEndpoints: Endpoint[] = [
  {
    ...
    serviceUrl: 'https://polkadot-api.mimiar.global/',
  ...
  },
  {
    ...
    serviceUrl: 'https://assethub-polkadot-api.mimiar.global/',
...
export const kusamaEndpoints: Endpoint[] = [
  {
    ...
    serviceUrl: 'https://kusama-api.mimiar.global/',
...
export const paseoEndpoints: Endpoint[] = [
  {
    ...
    serviceUrl: 'https://paseo-api.mimiar.global/'
  }
];
...
function _defaultApiUrl() {
  ...
  if (process.env.NODE_ENV === 'production') {
    if (window.location.hostname === 'dev.mimiar.global') {
      wsUrl = devEndpoints[0].wsUrl;
    } else if (window.location.hostname === 'app.mimiar.global' || window.location.hostname === 'staging-app.mimiar.global') {
