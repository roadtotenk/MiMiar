...
import { ReactComponent as IconCancel } from '@mimiar-wallet/assets/svg/icon-cancel.svg';
import { ReactComponent as IconFail } from '@mimiar-wallet/assets/svg/icon-failed-fill.svg';
import { ReactComponent as IconFailOutlined } from '@mimiar-wallet/assets/svg/icon-failed-outlined.svg';
import { ReactComponent as IconSuccess } from '@mimiar-wallet/assets/svg/icon-success-fill.svg';
import { ReactComponent as IconSuccessOutlined } from '@mimiar-wallet/assets/svg/icon-success-outlined.svg';
import { ReactComponent as IconTransfer } from '@mimiar-wallet/assets/svg/icon-transfer.svg';
import { ReactComponent as IconWaiting } from '@mimiar-wallet/assets/svg/icon-waiting-fill.svg';
import { useApi, useSelectedAccountCallback, useTxQueue } from '@mimiar-wallet/hooks';
