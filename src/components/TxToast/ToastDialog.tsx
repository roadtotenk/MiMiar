...
import type { TxEvents } from '@mimiar-wallet/utils';
import type { ISubmittableResult } from '@polkadot/types/types';

import ImgTxFailed from '@mimiar-wallet/assets/images/tx-failed.png';
import ImgTxPending from '@mimiar-wallet/assets/images/tx-pending.png';
import ImgTxSuccess from '@mimiar-wallet/assets/images/tx-success.png';
