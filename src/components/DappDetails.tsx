...
import { ReactComponent as IconDiscord } from '@mimiar-wallet/assets/svg/icon-discord.svg';
import { ReactComponent as IconGithub } from '@mimiar-wallet/assets/svg/icon-github.svg';
import { ReactComponent as IconWebsite } from '@mimiar-wallet/assets/svg/icon-website.svg';
import { ReactComponent as IconX } from '@mimiar-wallet/assets/svg/icon-x.svg';
import { type DappOption, findToken } from '@mimiar-wallet/config';
